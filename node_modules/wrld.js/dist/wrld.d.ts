...
export type { HeatmapOptions, ColorStop, ColorStopArray, DensityStop, DensityStopArray, OcclusionMapFeature, PointData, WeightedPoint, } from "./public/heatmap";
export type { MapFloorId, MapFloorIndex, MapId, MapOptions, ZoomPanOptions, PrecacheHandler, PrecacheResponse, } from "./public/map";
export { Map, map, indoors, space, themes, buildings, indoorMapEntities, indoorMapFloorOutlines, native, 
/** @internal */
getMapById, };
