...
import type { IndoorMap, IndoorMapFloor, IndoorMapEntrance, EnterConfig, IndoorMapEventHandler, IndoorMapFloorEventHandler, IndoorMapEntranceEventHandler, IndoorMapEntityEventHandler, EventType } from "../../public/indoors";
...
declare class IndoorsModule {
    ...
    setEntityHighlights(ids: string | string[], highlightColour: ColorArray, indoorId?: string, highlightBorderThickness?: number): void;
